...
| Model | Training Time | Inference Latency | Peak Memory | Accuracy |
|-------|---------------|-------------------|------------|----------|
| AlexNet | ~5263.78 seconds | 4.511 ms per image | 0.97 GB | ~87.60% |
| VGG16 | ~745.70 seconds | 0.552 ms per image | 1.83 GB | ~95% |
| ResNet18 | ~1261.18 seconds | 0.900 ms per image | 1.84 GB | ~98% |
| **CompactNet3** | **~646.17 seconds** | ** 0.604 ms per image** | **0.86 GB** | **99.96%** |
